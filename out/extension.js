...
const aiIntegration_1 = __webpack_require__(43);
// Typing Effect
...
async function getCodeSuggestions(code) {
    try {
        const response = await axios_1.default.post("http://localhost:8080/requirementsbits/v1/code_gen/", {
...
function showSuggestionInEditor(editor, suggestion, context) {
...
function insertResponseInEditor(editor, response) {
    const endOfDocument = editor.document.lineAt(editor.document.lineCount - 1).range.end;
    editor.edit(editBuilder => {
        editBuilder.insert(endOfDocument, `\n\n// LLM Response:\n${response}`);
    });
